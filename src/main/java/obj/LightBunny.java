 ...
 * @Version 1.0
 **/
public class LightBunny extends GameObj {
    private ShaderProgram program;
    private MaterialMesh mesh;
    private Material material;

    public LightBunny(Vector3f position, Vector3f rotation, float scale, ShaderProgram program) {
    ...
    private void init(ShaderProgram program){
        ...
        ObjModel objModel = ObjModel.loadObj(Constant.DEFAULT_RESOURCES_DIR + "/models/bunny.obj");
